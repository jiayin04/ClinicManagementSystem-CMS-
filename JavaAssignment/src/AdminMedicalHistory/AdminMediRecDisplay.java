...
public class AdminMediRecDisplay extends JFrame {
    ...
    AdminMediRecDisplay(String mediRecID) throws IOException, ParseException {
        ...
        mediRecordClass mediRecRetrieve = mediRecordClass.getRecordByMediRecId(mediRecID);
        if (mediRecRetrieve != null) {
            ...
            Patient patientIDRetrieve = mediRecordClass.getPatientById(rPatientID);
            ...
            Doctor doctorIDRetrieve = mediRecordClass.getDoctorById(rDoctorID);
        ...
        clinicNameLabel.setText("XYZ Clinic");
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(weightLabel, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
                                .addComponent(heightLabel, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                            .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addComponent(patientHeight, GroupLayout.PREFERRED_SIZE, 53, GroupLayout.PREFERRED_SIZE)
                                .addComponent(patientBloodType, GroupLayout.PREFERRED_SIZE, 109, GroupLayout.PREFERRED_SIZE)
                                .addComponent(patientWeight, GroupLayout.PREFERRED_SIZE, 53, GroupLayout.PREFERRED_SIZE))
                            .addGap(206, 206, 206))
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
    ...
    private void closeButtonActionPerformed(ActionEvent evt) throws IOException {
        this.dispose();
        new AdminMediRecManagement().setVisible(true);
    }
}
