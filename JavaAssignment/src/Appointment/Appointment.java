...
//    public static void viewAllAppointments(List<Appointment> appointments) {
//        for (Appointment appointment : appointments) {
...
//    public static Appointment findAppointmentByID(List<Appointment> appointments, String appointmentID) {
//        for (Appointment appointment : appointments) {
//            if (appointment.getAppointmentID().equals(appointmentID)) {
//                return appointment;
//            }
...
//    public static List<Appointment> getAppointmentsByDate(List<Appointment> appointments, String date) {
