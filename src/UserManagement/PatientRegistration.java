...
import Role.Patient;
import static Role.UserFileWriter.writePatientsToFile;
import java.awt.*;
...
public class PatientRegistration extends JFrame {
    ...
    PatientRegistration() {
        this.setTitle("Patient Registration"); //set the title of the frame
...
//          Information collection section
        ...
        registerButton.addActionListener((ActionEvent e) -> {
            ...
            //                    Increment rowCount
            int rowCount = getRowCount("src/TextFiles/PatientData.txt");
            int currentPatientID = rowCount + 1;
            String patientID = "P" + String.format("%04d", currentPatientID);
            ...
            try {
                FileWriter fw = new FileWriter("src/TextFiles/PatientData.txt", true);
