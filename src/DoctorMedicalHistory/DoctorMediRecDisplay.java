        ...
        updateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Patient's medical record updated successfully.");
                } catch (IOException ex) {
                    JOptionPane.showMessageDialog(null, "Failed to update patient's medical record. Please try again.");
                    ex.printStackTrace();
                }
            }
        });
