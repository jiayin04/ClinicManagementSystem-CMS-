...
import Role.Admin;
import UserManagement.AdminProfileManagement;
...
public class AdminViewProfile extends JFrame {
    ...
    public AdminViewProfile(String adminID) throws IOException, ParseException {
        ...
        JLabel titleLabel = new JLabel("Admin View Profile");
        ...
        for (Admin admin : admins) {
            ...
            if (adminIDRetrieve.equals(adminID)) {
                ...
                saveButton.addActionListener((ActionEvent e) -> {
                    ...
                    String passwordValue = String.valueOf(passwordField.getPassword()).trim();
                    // Perform validation checks
                    if (nameValue.isEmpty() || icValue.isEmpty() || emailValue.isEmpty() || contactNum.isEmpty() || emergencyNum.isEmpty() || passwordValue.isEmpty()) {
                    ...
                    for (Admin admin1 : admins) {
                        if (admin1.getId().equals(adminID)) {
                            ...
                            admin1.setPassword(passwordValue);
                            break;
                        }
                    }
                    try {
